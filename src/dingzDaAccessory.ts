...
export class DingzDaAccessory implements Disposable {
         ...
         private addDimmerService(name: string, id: DimmerId = 0) {
           ...
           service
             ...
             .on(
               ...
               this.setBrightness.bind(this, id),
         ...
         private async setPosition(
           ...
           const lamella: number = this.dingzStates.WindowCovers[id].target
             .lamella;
         ...
         private getPosition(
           ...
           const position: number = this.dingzStates.WindowCovers[id].current
             .blind;
         ...
         private getTiltAngle(
           ...
           const tiltAngle: number = this.dingzStates.WindowCovers[id].current
             .lamella;
         ...
         private async updateAccessory() {
           this.platform.log.debug(
             'Update accessory -> Check for changed config.',
           );
           ...
           const currentDingzDeviceInfo: DingzDeviceInfo = this.accessory
             .context.device.dingzDeviceInfo;
           const updatedDingzDeviceInfo: DingzDeviceInfo =
             this._updatedDeviceInfo ?? currentDingzDeviceInfo;

           const currentDingzInputInfo: DingzInputInfoItem = this.accessory
             .context.device.dingzInputInfo;
           ...
           try {
             if (
               ...
               // Update PIR Service
               this.platform.log.warn(
                 'Update accessory -> PIR config changed.',
               );
             ...
             if (
               ...
               // Update PIR Service
               this.platform.log.warn(
                 'Update accessory -> Input config changed.',
               );
